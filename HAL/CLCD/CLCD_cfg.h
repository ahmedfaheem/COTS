...
#define CLCD_u8RS_PIN        DIO_u8PIN5

#if CLCD_u8RW_CONN_STS == DIO_CONNECTED
#define CLCD_u8RW_PIN        DIO_u8PIN2
#endif

#define CLCD_u8E_PIN         DIO_u8PIN4
#define CLCD_u8DATA_PORT     DIO_u8PORTA


#if CLCD_u8BIT_MODE == FOUR_BIT
#define CLCD_u8D4    DIO_u8PIN0
#define CLCD_u8D5    DIO_u8PIN1
#define CLCD_u8D6    DIO_u8PIN2
#define CLCD_u8D7    DIO_u8PIN3
#endif
